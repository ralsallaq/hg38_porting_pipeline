...
#### ./nextflow run reference_update_comparison_pipeline.nf --params.mode 'crest' --crest_anls_run_names_file ./anls_run_name.csv --outD ./analysis
 ...
 ./nextflow run main.nf --mode 'crest-post' --crest_post_anls_run_names_file "../anls_run_name.csv" --lift_over_fromTo 'GRCh37-lite|to|GRCh38' --slop 100 --outD ./analysis -resume
